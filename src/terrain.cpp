...
void projTrans( double lon_0, double lat_0, GRID grid, float * coord, LONLAT LonLat  )
{
    ...
    //if ( thisRank == 2100 )
    //{
    //    cout << "============thisRank = " << thisRank << "============" << endl;
    //    cout << coord[1000] << endl;
    //}
	//printf( projStr  );
	//printf( "\n"  );
    ...
    //if ( thisRank == 2100 )
    //{
    //    cout << "============Print ????????????????? thisRank = " << thisRank << "============" << endl;
    //    cout << coord[1000] << endl;
    //}
...
void preprocessTerrain( PARAMS params, MPI_Comm comm_cart, MPI_COORD thisMPICoord, GRID grid, float * coord )
{
	...
	//	cout << "========================" << endl;
		...
		*/
		...
		{
			FILE * totalTerrainFile = fopen( "./output/totalTerrain.bin", "wb"  );
